...
<body class="page-header-fixed">
	...
	<div class="jumbotron " style="background-color: #428bca">
		...
		<div class="btn-group">
			<button type="button" class="btn btn-warning" onclick="regular();">
				<span class="glyphicon glyphicon-cog">常规保养</span>
			</button>
	...
	<div class="container-fluid">
		<table style="width: 100%">
			<tr>
				<td style="width: 30%;"><span style="color: #428bca">类型</span></td>
